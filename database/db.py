...
def update_user_name(username, new_username):
    update(Users).where(user_name = username).values(user_name = new_username)

def update_user_email(useremail, new_useremail):
    update(Users).where(email = useremail).values(email = new_useremail)

def update_partner_name(partner_name, new_partner_name):
    update(Partners).where(partnername = partner_name).values(partner_name = new_partner_name)
